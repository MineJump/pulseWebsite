                  ...
                  >
                    ...
                    {i === 1 && (
                      <div className="flex items-center gap-2 mt-2">
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] uppercase tracking-[0.12em]"
                          style={{ backgroundColor: "rgba(13,35,66,0.07)", color: "var(--text-muted)", fontFamily: "'IBM Plex Mono', monospace", border: "1px solid var(--border)" }}>
                          <svg width="10" height="10" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                            <path d="M11.07 7.37c-.02-1.9 1.56-2.82 1.63-2.86-.89-1.3-2.27-1.48-2.76-1.5-1.17-.12-2.29.69-2.89.69-.6 0-1.52-.67-2.5-.65-1.28.02-2.47.75-3.13 1.9C-.04 7.18.85 10.6 2.3 12.44c.72.99 1.57 2.1 2.69 2.06 1.08-.04 1.49-.7 2.79-.7 1.3 0 1.67.7 2.8.68 1.16-.02 1.9-1.01 2.6-2.01.83-1.15 1.17-2.27 1.19-2.33-.03-.01-2.28-.88-2.3-3.47zM8.93 2.13C9.49 1.45 9.87.52 9.77-.43 8.96-.38 8 .12 7.42.8c-.52.6-.98 1.55-.85 2.47.9.07 1.81-.44 2.36-1.14z" fill="currentColor"/>
                          </svg>
                          iOS
                        </span>
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] uppercase tracking-[0.12em]"
                          style={{ backgroundColor: "rgba(13,35,66,0.07)", color: "var(--text-muted)", fontFamily: "'IBM Plex Mono', monospace", border: "1px solid var(--border)" }}>
                          <svg width="10" height="10" viewBox="0 0 13 14" fill="none" aria-hidden="true">
